 ...
 * Configurate existing strucuture.
 * 
 * @author afinke
 *
 */
public class LiqConfPageExistingStructure extends WizardPage {
	...
	public LiqConfPageExistingStructure(LiqConfValues liqConfValues) {
		super("Create Liquibase Configuration");
		setTitle("Create Liquibase Configuration");
		setDescription("Create Liquibase configuration from existing structure.");
	...
	public void createControl(final Composite parent) {
	    ...
	    projectInfo.setText("ChangeLog Information: ");
	    ...
	    pathLabel.setText("ChangeLog Path: ");
	    ...
	    openButton.addSelectionListener(new SelectionAdapter() {
	    	...
	    	public void widgetSelected(SelectionEvent e) {
	    		...
	    		fileDialog.setFilterNames(new String[] { "Liquibase ChangeLog(*.xml)" });
	    		fileDialog.setFilterPath(workspacePath);
	    		String fileName = fileDialog.open();
	    		if(fileName != null) {
	...
	public void validatePage() {
		if (!urlText.getText().isEmpty() &&
			...
			enableFinish(); 
			liqConfValues.setExistingStructurePageComplete(true);
		} else {
			setPageComplete(false);
			liqConfValues.setExistingStructurePageComplete(false);
		}
	}
